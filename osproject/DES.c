...
static const uint8_t e_permtab[] PROGMEM = {
...
static const uint8_t p_permtab[] PROGMEM = {
         4,  4,                                         /* 32 bit -> 32 bit */
        16,  7, 20, 21,
        29, 12, 28, 17,
         1, 15, 23, 26,
...
static const uint8_t ip_permtab[] PROGMEM = {
         8,  8,                                         /* 64 bit -> 64 bit */
...
static const uint8_t inv_ip_permtab[] PROGMEM = {
         8, 8,                                          /* 64 bit -> 64 bit */
...
static const uint8_t pc1_permtab[] PROGMEM = {
         8,  7,                                         /* 64 bit -> 56 bit*/
        57, 49, 41, 33, 25, 17,  9,
         1, 58, 50, 42, 34, 26, 18,
        10,  2, 59, 51, 43, 35, 27,
...
static const uint8_t pc2_permtab[] PROGMEM = {
         7,      6,                                     /* 56 bit -> 48 bit */
        14, 17, 11, 24,  1,  5,
         3, 28, 15,  6, 21, 10,
        23, 19, 12,  4, 26,  8,
...
static const uint8_t splitin6bitword_permtab[] PROGMEM = {
         8,  8,                                         /* 64 bit -> 64 bit */
        64, 64,  1,  6,  2,  3,  4,  5, 
...
static const uint8_t shiftkey_permtab[] PROGMEM = {
         7,  7,                                         /* 56 bit -> 56 bit */
         2,  3,  4,  5,  6,  7,  8,  9,
...
static const uint8_t shiftkeyinv_permtab[] PROGMEM = {
         7,  7,
        28,  1,  2,  3,  4,  5,  6,  7,
...
static void permute(const uint8_t *ptable, const uint8_t *in, uint8_t *out){
...
static void changeendian32(uint32_t * a){
        *a = (*a & 0x000000FF) << 24 |
                 (*a & 0x0000FF00) <<  8 |
                 (*a & 0x00FF0000) >>  8 |
                 (*a & 0xFF000000) >> 24;
...
static uint32_t des_f(uint32_t r, uint8_t* kr){
        uint8_t i;
        uint32_t t=0,ret;
        uint64_t data;
