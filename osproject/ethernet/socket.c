...
uint16_t send(SOCKET s, const uint8_t * buf, uint16_t len)
{
  ...
  // copy data
  W5100_send_data_processing(&W5100, s, (uint8_t *)buf, ret);
...
int16_t recv(SOCKET s, uint8_t *buf, int16_t len)
{
  ...
  if ( ret > 0 )
  {
    W5100_recv_data_processing_3(&W5100, s, buf, ret);
...
{
  W5100_recv_data_processing_4(&W5100, s, buf, 1, 1);
...
uint16_t sendto(SOCKET s, const uint8_t *buf, uint16_t len, uint8_t *addr, uint16_t port)
{
  ...
  if (len > W5100_SSIZE) ret = W5100_SSIZE; // check size not to exceed MAX size.
  else ret = len;
...
uint16_t recvfrom(SOCKET s, uint8_t *buf, uint16_t len, uint8_t *addr, uint16_t *port)
{
  ...
  if ( len > 0 )
  {
    ...
    {
    case SnMR_UDP :
      W5100_read_data(&W5100, s, (uint8_t *)ptr, head, 0x08);
      ptr += 8;
      ...
      *port = (*port << 8) + head[5];
      ...
      W5100_read_data(&W5100, s, (uint8_t *)ptr, buf, data_len); // data copy.
      ptr += data_len;
    ...
    case SnMR_IPRAW :
      W5100_read_data(&W5100, s, (uint8_t *)ptr, head, 0x06);
      ptr += 6;
    ...
    case SnMR_MACRAW:
      W5100_read_data(&W5100, s,(uint8_t*)ptr,head,2);
      ptr+=2;
      data_len = head[0];
      data_len = (data_len<<8) + head[1] - 2;

      W5100_read_data(&W5100, s,(uint8_t*) ptr,buf,data_len);
      ptr += data_len;
      W5100_writeSnRX_RD(s, ptr);
      break;
...
uint16_t bufferData(SOCKET s, uint16_t offset, const uint8_t* buf, uint16_t len)
{
  ...
  W5100_send_data_processing_offset(&W5100, s, offset, buf, ret);
  return ret;
}
